                            ...
                            <div className='w-full flex flex-wrap relative overflow-hidden'>
                                ...
                                <div className='sm:w-1/2 pt-[18px] w-full md:pt-[34px]'>
                                    ...
                                    <div className="flex justify-center sm:justify-start">
                                        <img data-aos="zoom-in-up" data-aos-duration="1000" className=' mt-[12px] sm:mt-[32px] sm:mb-[64px] rounded-[20px] border-[3px] border-primary hover:shadow-hoverimgShadow' src={team.img} alt="team member" />
                                    </div>
                                </div>
                                <div className='w-full sm:w-1/2 pt-3 sm:pt-[18px] md:pt-[34px]' data-aos="fade-left" data-aos-duration="1500">
                                    <div className="flex justify-center sm:justify-start">
