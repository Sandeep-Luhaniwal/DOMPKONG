                ...
                <div className="cotainer mx-auto max-w-[1140px] px-3 overflow-x-hidden pt-5 sm:pt-[60px] md:pt-[90px] md:pb-8">
                    ...
                    <div className=" flex-wrap flex">
                        ...
                        <div className='w-full md:w-7/12 md:hidden ps-4 pt-[24px]'>
                            <div className="relative before:absolute before:h-[105%] before:w-[3px] before:bg-primary before:left-[-8px] sm:before:left-[-6px] before:top-[20px] sm:before:top-[35px]">
                                <div className='flex relative ms-3 sm:ms-5'>
                                    <div className='h-[50px] sm:h-[76px] w-full max-w-[50px] sm:max-w-[76px] rounded-full  bg-white hover:bg-primary hover:shadow-circleShadow flex justify-center items-center relative'>
                        ...
                        <div className="relative w-full md:w-5/12 hidden md:block">
                            ...
                            <div className='h-[30px] w-[30px] shadow-circleShadow bg-primary rounded-full absolute top-[4%] lg:left-[46%] md:left-[70%] '></div>
                            <div className='h-[30px] w-[30px] shadow-circleShadow bg-primary rounded-full absolute lg:top-[24%] md:top-[27%] lg:right-[27%] md:right-0'></div>
                            <div className='h-[30px] w-[30px] shadow-circleShadow bg-primary rounded-full absolute lg:top-[46%] md:top-[46%] lg:right-[22%] md:right-[-4%] '></div>
                            <div className='h-[30px] w-[30px] shadow-circleShadow bg-primary rounded-full absolute lg:top-[67%] md:top-[65%] lg:right-[26%] md:right-[0]'></div>
                            <div className='h-[30px] w-[30px] shadow-circleShadow bg-primary rounded-full absolute lg:top-[89%] lg:right-[45%] md:top-[86%] md:right-[15%] '></div>
                        </div>
                        <div className='w-full md:w-7/12 hidden md:block'>
                            <div className='flex relative pt-[24px] md:pt-0 md:ms-[-32px] '>
                                <div className="flex changecolor" data-aos="fade-right" data-aos-duration="1000">
                                    <div className='h-[50px] sm:h-[76px] circle w-full max-w-[50px] sm:max-w-[76px] rounded-full circle hover:bg-primary  bg-white flex justify-center items-center relative'>
                            ...
                            <div className='flex relative pt-[24px] md:pt-[20px] lg:pt-[37px] md:ms-[8px]'>
                                <div className='flex changecolor' data-aos="fade-right" data-aos-duration="1900">
                                    <div className='h-[50px] sm:h-[76px] w-full max-w-[50px] sm:max-w-[76px] rounded-full circle hover:bg-primary bg-white  flex justify-center items-center relative'>
                                        <div className='hidden lg:block w-[90px] lg:w-[90px] h-[1px] bg-white absolute top-[50%] translate-y-[-50%] lg:left-[-110px] after:absolute after:h-[10px] after:rounded-full after:w-[10px] after:top-[-5px] after:right-0 after:bg-white before:absolute before:bg-white before:w-[10px] before:h-[10px] before:rounded-full before:top-[-5px] before:left-0 '></div>
                            ...
                            <div className='flex relative pt-[24px] md:ms-[-32px] md:pt-[20px] lg:pt-[37px]'>
                                <div className="flex changecolor" data-aos="fade-right" data-aos-duration="2200">
                                    <div className='h-[50px] sm:h-[76px] w-full max-w-[50px] sm:max-w-[76px] rounded-full hover:bg-primary circle bg-white  flex justify-center items-center relative'>
