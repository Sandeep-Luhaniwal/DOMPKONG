                    ...
                    <div className=" flex-wrap flex">
                        ...
                        <div className='w-full md:w-7/12 hidden md:block'>
                            <div className='flex relative pt-[24px] md:pt-0 md:ms-[-32px]'>
                                <div className='h-[50px] sm:h-[76px] w-full max-w-[50px] sm:max-w-[76px] rounded-full changecolor hover:bg-primary hover:shadow-circleShadow  bg-white flex justify-center items-center relative'>
                            ...
                            <div className='flex relative pt-[24px] md:ms-[-32px] md:pt-[20px] lg:pt-[37px]'>
                                <div className='h-[50px] sm:h-[76px] w-full max-w-[50px] sm:max-w-[76px] rounded-full hover:bg-primary hover:shadow-circleShadow changecolor bg-white  flex justify-center items-center relative'>
