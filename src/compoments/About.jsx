                ...
                <div className="cotainer mx-auto max-w-[1140px] relative px-3">
                    <div className="flex flex-wrap pt-8 sm:pt-[60px] md:pt-[130px] pb-[90px] overflow-hidden">
                        ...
                        <div className='w-full md:w-1/2 pt-[100px] pb-[150px] md:py-0'>
                            <div className='w-full m-auto box-border ms-[25px] lg:ms-[35px] !rotate-[18deg]' data-aos="zoom-in-up" data-aos-duration="1000">
                                <div class="entire-content m-auto w-[170px] relative pt-[25px] lg:pb-5 cursor-pointer">
