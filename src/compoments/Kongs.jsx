            ...
            <div className='bg-black md:min-h-[1040px] min-h-[670px] sm:min-h-[920px] overflow-x-hidden py-3'>
                <div className='flex flex-col justify-center items-center relative'>
                    ...
                    <div className="flex flex-col md:flex mt-3 sm:mt-0">
                        <ul className='mb-0 px-2 md:px-0 bg-black z-20 flex gap-3 min-w-[390px] scroll-smooth'>
                            <li onClick={() => handleTabClick("First")} className="cursor-pointer">
                                <span className={`md:absolute md:top-0 md:left-1 lg:left-[-20px] z-20 ${activetab === "First" ? "" : ""}`}>
                                    <img src={firstimage} data-aos="fade-right" data-aos-duration="1000" alt="img1" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05] transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                            <li onClick={() => handleTabClick("Second")} className="cursor-pointer">
                                <span className={`md:absolute md:top-[210px] md:left-[4px] lg:left-[64px] z-20 ${activetab === "Second" ? "" : ""}`}>
                                    <img src={secondimage} data-aos="fade-right" data-aos-duration="1400" alt="img2" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05] transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                            <li onClick={() => handleTabClick("Thrid")} className="cursor-pointer">
                                <span className={`md:absolute md:top-[420px] md:left-[4px] lg:left-[174px] z-20 ${activetab === "Thrid" ? "" : ""}`}>
                                    <img src={thirdimage} data-aos="fade-right" data-aos-duration="1800" alt="img3" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05] transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                            <li onClick={() => handleTabClick("Fourth")} className="cursor-pointer">
                                <span className={`md:absolute md:top-[630px] md:left-[4px] lg:left-[64px] z-20 ${activetab === "Fourth" ? "" : ""}`}>
                                    <img src={fourthimage} data-aos="fade-right" data-aos-duration="1400" alt="img4" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05] transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                            <li onClick={() => handleTabClick("Five")} className="cursor-pointer">
                                <span className={`md:absolute md:top-[840px] md:left-[4px] lg:left-[-20px] z-20 ${activetab === "Five" ? "" : ""}`}>
                                    <img src={fifthimage} data-aos="fade-right" data-aos-duration="1000" alt="img5" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05] transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                            <li onClick={() => handleTabClick("Six")} className="cursor-pointer hidden md:block">
                                <span className={`md:absolute md:md:right-1 lg:right-[-20px] top-0 z-20 ${activetab === "Six" ? " " : ""}`}>
                                    <img src={siximage} data-aos="fade-left" data-aos-duration="1000" alt="img6" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05] transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                            <li onClick={() => handleTabClick("Seven")} className="cursor-pointer hidden md:block">
                                <span className={`md:absolute md:top-[210px] md:right-1 lg:right-[64px] z-20 ${activetab === "Seven" ? "" : ""}`}>
                                    <img src={sevenimage} data-aos="fade-left" data-aos-duration="1400" alt="img7" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05] transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                            <li onClick={() => handleTabClick("Eight")} className="cursor-pointer hidden md:block">
                                <span className={`md:absolute md:top-[420px] md:right-1 lg:right-[174px] z-20 ${activetab === "Eight" ? "" : ""}`}>
                                    <img src={eightimage} data-aos="fade-left" data-aos-duration="1800" alt="img8" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05] transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                            <li onClick={() => handleTabClick("Nine")} className="cursor-pointer hidden md:block">
                                <span className={`md:absolute md:top-[630px] md:right-1 lg:right-[64px] z-20 ${activetab === "Nine" ? "" : ""}`}>
                                    <img src={nineimage} data-aos="fade-left" data-aos-duration="1400" alt="img9" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05] transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                            <li onClick={() => handleTabClick("Ten")} className="cursor-pointer hidden md:block">
                                <span className={`md:absolute md:top-[840px] md:right-1 lg:right-[-20px] z-20 ${activetab === "Ten" ? "" : ""}`}>
                                    <img src={tenimage} data-aos="fade-left" data-aos-duration="1000" alt="img10" className='w-full max-w-[180px] hover:shadow-hoverimgShadow hover:scale-[1.05]  transition-all duration-500 rounded-[8px] border-[4px] border-primary' />
                                </span>
                            </li>
                        </ul>
                    ...
                    <div className=' w-full flex justify-center'>
                        <div className='flex justify-center relative'>
                            <div className="flex justify-center items-center absolute top-[0px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] ">
                                <img src={kongs} data-aos="zoom-out" data-aos-duration="1500" alt="center" className='lg:max-w-[786px] md:max-w-[600px] w-full' />
                            </div>
                            {activetab === "First" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center'>
                                        <img src={firstcenter} alt="monkey" className='w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                            {activetab === "Second" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center'>
                                        <img src={secondcenter} alt="monkey" className='w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                            {activetab === "Thrid" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center '>
                                        <img src={thirdcenter} alt="monkey" className='w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                            {activetab === "Fourth" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center'>
                                        <img src={fouthcenter} alt="monkey" className='w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                            {activetab === "Five" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center'>
                                        <img src={fivecenter} alt="monkey" className='w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                            {activetab === "Six" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center'>
                                        <img src={sixcenter} alt="monkey" className='w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                            {activetab === "Seven" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center'>
                                        <img src={sevencenter} alt="monkey" className='w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                            {activetab === "Eight" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center'>
                                        <img src={eightcenter} alt="monkey" className='md:max-w-[512px] w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                            {activetab === "Nine" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center'>
                                        <img src={ninecenter} alt="monkey" className='w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                            {activetab === "Ten" && (
                                <div className="flex justify-center items-center absolute top-[0px] md:left-[-420px] w-[330px] sm:w-[600px] md:w-[786px] md:h-[700px] bg-black">
                                    <div className='flex justify-center'>
                                        <img src={tencenter} alt="monkey" className='w-full lg:min-w-[600px]' />
                                    </div>
                                </div>
                            )}
                        </div>
